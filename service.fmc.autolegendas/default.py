...
__settings__ = xbmcaddon.Addon("service.fmc.autolegendas")
...
def Debug(msg, force = False):
    if(debug == "true" or force):
        try:
            print "#####[AutoLegendas]##### " + msg
        except UnicodeEncodeError:
            print "#####[AutoLegendas]##### " + msg.encode( "utf-8", "ignore" )
...
def isExcluded(movieFullPath):
    ...
    if (movieFullPath.find("https://") > -1) and getSettingAsBool('ExcludeHTTPS'):
